...
public class Product {
    ...
    public Product(String product_id, String product_name, String product_description, double product_price, String vendor_id) {
    ...
    public String addProduct(String product_name, String product_description, double product_price, String vendor_id) {
